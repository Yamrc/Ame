...
const ROW_CONTENT_GAP: f32 = 14.;
const ALBUM_COLUMN_WIDTH: f32 = 300.;
...
pub fn render(props: TrackItemProps, actions: TrackItemActions) -> AnyElement {
    ...
    let row_id: SharedString = format!("track-item-row-{}", props.id).into();
    ...
    let menu_id = format!("track-item-menu-{}", props.id);
